...
export default {
  ...
  'claude_draft_title': 'Trợ lý bản nháp Claude',
  'claude_draft_warning': 'Chỉ tạo bản nháp; không phê duyệt cổng duyệt và không tạo media.',
  'claude_draft_instruction_label': 'Chỉ dẫn tuỳ chọn',
  'claude_draft_instruction_placeholder': 'Ví dụ: tập trung vào hook mở đầu, động cơ nhân vật và asset còn thiếu',
  'claude_draft_action': 'Hỏi Claude tạo bản nháp đánh giá',
  'claude_draft_running': 'Đang gửi...',
  'claude_draft_created': 'Đã tạo bản nháp Claude',
  'claude_draft_failed': 'Không thể tạo bản nháp Claude',
  'claude_draft_summary_title': 'Tóm tắt bản nháp Claude',
  'claude_draft_findings_title': 'Gợi ý bản nháp',
  'claude_draft_copy': 'Sao chép bản nháp',
  'claude_draft_copied': 'Đã sao chép bản nháp',
  'claude_draft_copy_failed': 'Sao chép thất bại',
