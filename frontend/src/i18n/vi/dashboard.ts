...
export default {
  ...
  'local_workflow_title': 'Quy trình sản xuất cục bộ',
  'local_workflow_hint': 'Ưu tiên duyệt thủ công: kiểm tra kịch bản và asset trước storyboard, video và xuất bản.',
  'local_workflow_stage_brief_gate': 'Tóm tắt sáng tạo',
  'local_workflow_stage_script_gate': 'Duyệt kịch bản',
  'local_workflow_stage_asset_gate': 'Kiểm tra asset',
  'local_workflow_stage_storyboard_gate': 'Duyệt storyboard',
  'local_workflow_stage_video_gate': 'Tạo video',
  'local_workflow_stage_export_gate': 'Kiểm tra xuất',
  'local_workflow_status_complete': 'Hoàn tất',
  'local_workflow_status_ready': 'Sẵn sàng',
  ...
  'local_workflow_checklist_title': 'Checklist duyệt thủ công',
  'local_workflow_checklist_character_consistency': 'Nhất quán nhân vật',
  'local_workflow_checklist_scene_prop_consistency': 'Nhất quán cảnh/đạo cụ',
  'local_workflow_checklist_shot_count': 'Số lượng cảnh quay',
  'local_workflow_checklist_prompt_quality': 'Chất lượng prompt',
  'local_workflow_checklist_motion_continuity': 'Liên tục chuyển động',
  'local_workflow_checklist_face_stability': 'Ổn định khuôn mặt',
  'local_workflow_checklist_duration_rhythm': 'Thời lượng/nhịp',
  'local_workflow_checklist_first_last_frame': 'Khung đầu/cuối',
  'local_workflow_checklist_subtitles_audio': 'Phụ đề/âm thanh',
  ...
  'local_workflow_failed_checklist_empty': 'Chưa đạt: không có',
  ...
  'local_workflow_export_package': 'Xuất gói duyệt',
  'local_workflow_import_prompt': 'Nhập Prompt',
  'local_workflow_prompt_label': 'Seedance Prompt',
  'local_workflow_prompt_placeholder': 'Dán hoặc viết Seedance prompt. Không tự động tạo video.',
  'local_workflow_prompt_empty': 'Chưa nhập',
  'local_workflow_copy_rework_brief': 'Sao chép ghi chú sửa',
  'local_workflow_artifacts_saved': 'Đã lưu sổ sản xuất cục bộ',
  'local_workflow_artifact_title': 'Sổ sản xuất thủ công',
  'local_workflow_artifact_storyboard': 'Sản phẩm phân cảnh',
  'local_workflow_artifact_video': 'Sản phẩm video',
  'local_workflow_artifact_export': 'Sản phẩm xuất bản',
  'local_workflow_artifact_storyboard_path_label': 'Tệp/liên kết phân cảnh',
  'local_workflow_artifact_video_path_label': 'Tệp/liên kết video',
  'local_workflow_artifact_export_path_label': 'Tệp thành phẩm/bản nháp',
  'local_workflow_artifact_storyboard_note_label': 'Ghi chú phân cảnh',
  'local_workflow_artifact_video_note_label': 'Ghi chú video',
  'local_workflow_artifact_export_note_label': 'Ghi chú xuất bản',
  'local_workflow_artifact_path_placeholder': 'Dán đường dẫn cục bộ hoặc liên kết',
  'local_workflow_artifact_note_placeholder': 'Ghi chú thủ công (tuỳ chọn)',
  'local_workflow_save_artifacts': 'Lưu sổ sản xuất',
  'local_workflow_package_json_label': 'JSON gói duyệt',
  'local_workflow_package_json_placeholder': 'Dán JSON gói duyệt đã xuất để khôi phục prompt và sổ sản phẩm.',
  'local_workflow_apply_package': 'Áp dụng gói',
  'production_board_title': 'Bảng sản xuất phim ngắn',
  'production_board_hint': 'Tổng hợp trạng thái kịch bản, phân cảnh, video, xuất bản, prompt và sản phẩm thủ công theo từng tập.',
  'production_board_export_csv': 'Xuất danh sách sản xuất',
  'production_board_qa_blocked': 'QA bị chặn',
  'production_board_rework': 'Điểm cần sửa',
  'production_board_missing_prompt': 'Thiếu Prompt',
  'production_board_missing_video': 'Thiếu video',
  'production_board_missing_export': 'Thiếu thành phẩm',
  'production_board_episode': 'Tập',
  'production_board_script': 'Kịch bản',
  'production_board_storyboard': 'Phân cảnh',
  'production_board_video': 'Video',
  'production_board_export': 'Xuất bản',
  'production_board_issues': 'Vấn đề',
  'production_board_actions': 'Thao tác',
  'production_board_open_episode': 'Mở E{{episode}}',
