...
export default {
  ...
  'claude_draft_title': 'Claude draft assistant',
  'claude_draft_warning': 'Creates a draft only; it does not approve gates or generate media.',
  'claude_draft_instruction_label': 'Optional instruction',
  'claude_draft_instruction_placeholder': 'For example: focus on the opening hook, character motivation, and missing assets',
  'claude_draft_action': 'Ask Claude for review draft',
  'claude_draft_running': 'Requesting...',
  'claude_draft_created': 'Claude draft created',
  'claude_draft_failed': 'Could not create Claude draft',
  'claude_draft_summary_title': 'Claude draft summary',
  'claude_draft_findings_title': 'Draft suggestions',
  'claude_draft_copy': 'Copy draft',
  'claude_draft_copied': 'Draft copied',
  'claude_draft_copy_failed': 'Copy failed',
