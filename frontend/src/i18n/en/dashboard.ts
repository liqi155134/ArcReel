...
export default {
  ...
  'local_workflow_title': 'Local production workflow',
  'local_workflow_hint': 'Manual review first: clear script and assets before storyboard images, video, and export.',
  'local_workflow_stage_brief_gate': 'Creative brief',
  'local_workflow_stage_script_gate': 'Script review',
  'local_workflow_stage_asset_gate': 'Asset check',
  'local_workflow_stage_storyboard_gate': 'Storyboard review',
  'local_workflow_stage_video_gate': 'Video generation',
  'local_workflow_stage_export_gate': 'Export check',
  'local_workflow_status_complete': 'Complete',
  'local_workflow_status_ready': 'Ready',
  ...
  'local_workflow_checklist_title': 'Manual review checklist',
  'local_workflow_checklist_character_consistency': 'Character consistency',
  'local_workflow_checklist_scene_prop_consistency': 'Scene/prop consistency',
  'local_workflow_checklist_shot_count': 'Shot count',
  'local_workflow_checklist_prompt_quality': 'Prompt quality',
  'local_workflow_checklist_motion_continuity': 'Motion continuity',
  'local_workflow_checklist_face_stability': 'Face stability',
  'local_workflow_checklist_duration_rhythm': 'Duration/rhythm',
  'local_workflow_checklist_first_last_frame': 'First/last frame',
  'local_workflow_checklist_subtitles_audio': 'Subtitles/audio',
  ...
  'local_workflow_failed_checklist_empty': 'Failed: none',
  ...
  'local_workflow_export_package': 'Export review package',
  'local_workflow_import_prompt': 'Import Prompt',
  'local_workflow_prompt_label': 'Seedance Prompt',
  'local_workflow_prompt_placeholder': 'Paste or write a Seedance prompt. This will not generate video automatically.',
  'local_workflow_prompt_empty': 'Not imported',
  'local_workflow_copy_rework_brief': 'Copy rework brief',
  'local_workflow_artifacts_saved': 'Local production ledger saved',
  'local_workflow_artifact_title': 'Manual production ledger',
  'local_workflow_artifact_storyboard': 'Storyboard artifact',
  'local_workflow_artifact_video': 'Video artifact',
  'local_workflow_artifact_export': 'Export artifact',
  'local_workflow_artifact_storyboard_path_label': 'Storyboard file/link',
  'local_workflow_artifact_video_path_label': 'Video file/link',
  'local_workflow_artifact_export_path_label': 'Final/Cut draft file',
  'local_workflow_artifact_storyboard_note_label': 'Storyboard note',
  'local_workflow_artifact_video_note_label': 'Video note',
  'local_workflow_artifact_export_note_label': 'Export note',
  'local_workflow_artifact_path_placeholder': 'Paste a local path or link',
  'local_workflow_artifact_note_placeholder': 'Manual note (optional)',
  'local_workflow_save_artifacts': 'Save production ledger',
  'local_workflow_package_json_label': 'Review package JSON',
  'local_workflow_package_json_placeholder': 'Paste an exported review package JSON to restore prompt and artifact ledger.',
  'local_workflow_apply_package': 'Apply package',
  'production_board_title': 'Short-drama production board',
  'production_board_hint': 'Aggregates script, storyboard, video, export, prompt, and manual artifact status per episode for human scheduling only.',
  'production_board_export_csv': 'Export production checklist',
  'production_board_qa_blocked': 'QA blocked',
  'production_board_rework': 'Rework blockers',
  'production_board_missing_prompt': 'Missing Prompt',
  'production_board_missing_video': 'Missing video',
  'production_board_missing_export': 'Missing final',
  'production_board_episode': 'Episode',
  'production_board_script': 'Script',
  'production_board_storyboard': 'Storyboard',
  'production_board_video': 'Video',
  'production_board_export': 'Export',
  'production_board_issues': 'Issues',
  'production_board_actions': 'Actions',
  'production_board_open_episode': 'Open E{{episode}}',
