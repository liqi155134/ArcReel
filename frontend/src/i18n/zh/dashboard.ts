...
export default {
  ...
  'claude_draft_title': 'Claude 草稿助手',
  'claude_draft_warning': '只创建草稿，不放行审核，不生成媒体。',
  'claude_draft_instruction_label': '可选指令',
  'claude_draft_instruction_placeholder': '例如：重点检查开场钩子、人物动机和缺失资产',
  'claude_draft_action': '向 Claude 请求审核草稿',
  'claude_draft_running': '请求中...',
  'claude_draft_created': 'Claude 草稿已创建',
  'claude_draft_failed': 'Claude 草稿创建失败',
  'claude_draft_summary_title': 'Claude 草稿摘要',
  'claude_draft_findings_title': '草稿建议',
  'claude_draft_copy': '复制草稿',
  'claude_draft_copied': '草稿已复制',
  'claude_draft_copy_failed': '复制失败',
