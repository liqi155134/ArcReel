...
export default {
  ...
  'local_workflow_title': '本地生产流程',
  'local_workflow_hint': '手动审核优先：先过脚本和资产，再进分镜图、视频和导出。',
  'local_workflow_stage_brief_gate': '创作简报',
  'local_workflow_stage_script_gate': '脚本审核',
  'local_workflow_stage_asset_gate': '资产核对',
  'local_workflow_stage_storyboard_gate': '分镜图审核',
  'local_workflow_stage_video_gate': '视频生成',
  'local_workflow_stage_export_gate': '导出检查',
  'local_workflow_status_complete': '完成',
  'local_workflow_status_ready': '就绪',
  ...
  'local_workflow_checklist_title': '人工审核清单',
  'local_workflow_checklist_character_consistency': '角色一致性',
  'local_workflow_checklist_scene_prop_consistency': '场景/道具一致性',
  'local_workflow_checklist_shot_count': '镜头数量',
  'local_workflow_checklist_prompt_quality': '提示词质量',
  'local_workflow_checklist_motion_continuity': '动作连续性',
  'local_workflow_checklist_face_stability': '脸部稳定',
  'local_workflow_checklist_duration_rhythm': '时长/节奏',
  'local_workflow_checklist_first_last_frame': '首尾帧',
  'local_workflow_checklist_subtitles_audio': '字幕/声音',
  ...
  'local_workflow_failed_checklist_empty': '未通过：无',
  'local_workflow_mark_fixed': '标记已修复，重新审核',
  'local_workflow_rework_hint': '此操作只把该阶段退回待人工复审，不会自动通过。',
  'local_workflow_export_package': '导出审核包',
  'local_workflow_import_prompt': '导入 Prompt',
  'local_workflow_prompt_label': 'Seedance Prompt',
  'local_workflow_prompt_placeholder': '粘贴或手写 Seedance prompt，不会自动生成视频。',
  'local_workflow_prompt_empty': '未导入',
  'local_workflow_copy_rework_brief': '复制返工说明',
  'local_workflow_artifacts_saved': '本地生产台账已保存',
  'local_workflow_artifact_title': '人工生产台账',
  'local_workflow_artifact_storyboard': '分镜图产物',
  'local_workflow_artifact_video': '视频产物',
  'local_workflow_artifact_export': '导出产物',
  'local_workflow_artifact_storyboard_path_label': '分镜图文件/链接',
  'local_workflow_artifact_video_path_label': '视频文件/链接',
  'local_workflow_artifact_export_path_label': '成片/剪映文件',
  'local_workflow_artifact_storyboard_note_label': '分镜图备注',
  'local_workflow_artifact_video_note_label': '视频备注',
  'local_workflow_artifact_export_note_label': '导出备注',
  'local_workflow_artifact_path_placeholder': '粘贴本地路径或链接',
  'local_workflow_artifact_note_placeholder': '人工备注（可选）',
  'local_workflow_save_artifacts': '保存生产台账',
  'local_workflow_package_json_label': '审核包 JSON',
  'local_workflow_package_json_placeholder': '粘贴已导出的审核包 JSON，用于恢复 Prompt 和产物台账。',
  'local_workflow_apply_package': '应用审核包',
  'production_board_title': '短剧生产看板',
  'production_board_hint': '聚合每集脚本、分镜、视频、导出、Prompt 和人工产物状态，只做人工调度。',
  'production_board_export_csv': '导出生产清单',
  'production_board_qa_blocked': 'QA 阻塞',
  'production_board_rework': '返工卡点',
  'production_board_missing_prompt': '缺 Prompt',
  'production_board_missing_video': '缺视频',
  'production_board_missing_export': '缺成片',
  'production_board_episode': '集',
  'production_board_script': '脚本',
  'production_board_storyboard': '分镜',
  'production_board_video': '视频',
  'production_board_export': '导出',
  'production_board_issues': '问题',
  'production_board_actions': '操作',
  'production_board_open_episode': '打开 E{{episode}}',
