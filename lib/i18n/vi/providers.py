...
MESSAGES: dict[str, str] = {
    ...
    "provider_desc_dreamina-cli": "CLI Dreamina chính thức với đăng nhập OAuth cục bộ (không cần API key), hỗ trợ tạo video Seedance và ảnh Seedream, tính phí theo tín dụng tài khoản.",
