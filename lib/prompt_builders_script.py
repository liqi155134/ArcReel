...
def _render_prompt_rules_block(content_mode: str) -> str:
    if not is_v2_enabled():
        return ""
    return (
        render_pacing_section(content_mode)
        + "\n\n"
        + render_short_drama_standards_section(content_mode)
        + "\n\n"
    )
...
def build_narration_prompt(
    ...
    """
    prompt_rules_block = _render_prompt_rules_block("narration")
...
def build_drama_prompt(
    ...
    """
    prompt_rules_block = _render_prompt_rules_block("drama")
